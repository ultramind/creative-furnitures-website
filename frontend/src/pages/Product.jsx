...
const Product = () => {
  ...
  const [loading, setyLoading] = useState(true);
  const {
    catergory,
    countInStock,
    description,
          ...
          "
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="flex gap-2 items-center">
                    <GiReturnArrow className="text-primary" /> 6 months Day
                    Resturn Policy
                  </p>
                  <p className="flex gap-2 items-center">
                    {" "}
            ...
            <div className="my-24">
              ...
              <div className="relative p-4">
                ...
                >
                  <p>
                    First tab Lorem ipsum dolor sit, amet consectetur
                    adipisicing elit. Deserunt dicta dolor repellat accusantium
                    temporibus dolorem id quaerat, veniam soluta eveniet natus
                    dolorum corrupti fugit culpa labore ducimus inventore
                    consequatur ipsa?
                  </p>
                  <p>
                    <br />
